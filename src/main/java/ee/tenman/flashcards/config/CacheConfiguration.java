...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(ee.tenman.flashcards.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(ee.tenman.flashcards.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
